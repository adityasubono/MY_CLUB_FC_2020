                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="news-item left-news">
                            <div class="ni-pic set-bg" data-setbg="../assets/img/news/latest-b.jpg">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="news-item">
                            <div class="ni-pic">
                                <img src="../assets/img/news/ln-4.jpg" alt="">
                            </div>
                            <div class="ni-text">
                ...
                <div class="points-table">
                    <table>
                        ...
                        <tr>
                            <td>6</td>
                            <td class="team-name">
                                <img src="../assets/img/flag/flag-6.jpg" alt="">
                                <span>Turkme</span>
                            </td>
                            <td>161</td>
                            <td>1</td>
                        ...
                        <tr>
                            <td>7</td>
                            <td class="team-name">
                                <img src="../assets/img/flag/flag-7.jpg" alt="">
                                <span>Sri Lanka</span>
                            </td>
                            <td>15</td>
                            <td>4</td>
                        ...
                        <tr>
                            <td>8</td>
                            <td class="team-name">
                                <img src="../assets/img/flag/flag-8.jpg" alt="">
                                <span>Myanmar</span>
                            </td>
                            <td>14</td>
                            <td>3</td>
