    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6 p-0">
                <div class="soccer-item set-bg" data-setbg="../assets/img/soccer/soccer-1.jpg">
            ...
            <div class="col-lg-3 col-sm-6 p-0">
                <div class="soccer-item set-bg" data-setbg="../assets/img/soccer/soccer-2.jpg">
                    <div class="si-tag">Soccer</div>
                    <div class="si-text">
            ...
            <div class="col-lg-3 col-sm-6 p-0">
                <div class="soccer-item set-bg" data-setbg="../assets/img/soccer/soccer-3.jpg">
                    <div class="si-tag">Soccer</div>
                    <div class="si-text">
            ...
            <div class="col-lg-3 col-sm-6 p-0">
                <div class="soccer-item set-bg" data-setbg="../assets/img/soccer/soccer-4.jpg">
                    <div class="si-tag">Soccer</div>
                    <div class="si-text">
